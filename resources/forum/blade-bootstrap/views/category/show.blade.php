...
@section('content')
    <div class="mb-2 text-center">
        ...
        @if ($category->description)
                <br>
                <p class="text text-mute py-1">- {{ $category->description }} -</p>
            @endif
        </div>
                    ...
                    @can ('manageThreads', $category)
                            <div class="fixed-bottom-right pb-xs-0 pr-xs-0 pb-sm-3 pr-sm-3 m-2" style="z-index: 1000;">
                                <transition name="fade">
                                    <div class="card text-white bg-light shadow-sm" v-if="state.selectedThreads.length">
                                        <div class="card-header text-center">
                                            {{ trans('forum::general.with_selection') }}
                                        </div>
                                        <div class="card-body">
                                            <p for="bulk-actions">{{ trans_choice('forum::general.actions', 1) }}</p>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                </div>
                                                <select class="form-select rounded-pill" id="bulk-actions" v-model="state.selectedAction">
                                            ...
                                            <div v-if="state.selectedAction == 'move'">
                                                <p for="category-id">{{ trans_choice('forum::categories.category', 1) }}</p>
                                                <div class="mb-3">
